<?php
  ...
  if(!$delRow){
    ...
    header("Location: teaminfo.php"); //used to return to previous page
...
<html lang="en">
  ...
  <body>
    ...
    <p>Below information has been deleted from the table "Team Info".</p>
    <table>
      <tr>
        <td>Row ID</td>
    ...
    <button type='button' onclick='location.href="../teaminfo.php"'>Return to Team Driver Info</button>
  </body>
</html>
